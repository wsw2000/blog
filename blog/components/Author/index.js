  ...
  useEffect(() => {
    ...
    const reduce = () => {
      if (i > 0) {
        ...
        timeNull.null1 = setTimeout(() => {
          reduce()
        }, 500)
      } else {
        i = 1
        divTyping.innerHTML = '_'
        timeNull.null2 = setTimeout(() => {
          typing()
        }, 500)
      }
    }
    ...
    <>
      <div className='author-div comm-box'>
        ...
        <div className='author-introduction'>
          ...
          {props.defaultState &&
          props.defaultState.listType &&
          props.defaultState.visible ? (
            <>
              <Divider>导航</Divider>
              <Menu
          ...
          <Popover
            content={'码云：https://gitee.com/wu_chao_wen'}
            placement='bottom'
          >
            <a href='https://gitee.com/wu_chao_wen' target='_blank'>
              <Avatar
                style={{
                  background: props.defaultState.isFixed
                    ? '#c2bdeb'
                    : '#999999',
                }}
                size={28}
          ...
          <Popover
            content={'GitHub：https://github.com/wsw2000'}
            placement='bottom'
          >
          ...
          <Popover
            content={
              <>
                <img
                  src='http://www.wsw2000.top/images/qq.png'
                  style={{ width: '150px' }}
                  alt='qq'
          ...
          >
            <Avatar
              style={{
                background: props.defaultState.isFixed ? '#c2bdeb' : '#999999',
              }}
              size={28}
              icon='qq'
              className='account'
          ...
          <Popover
            content={
              <>
                <img
                  src='http://www.wsw2000.top/images/wechat.png'
